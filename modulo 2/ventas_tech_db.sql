...
-- Ejecutar una sola vez, en una conexión aparte, antes del resto del script:
-- CREATE DATABASE Ventas_Tech_DB;

-- ============================================================
-- 1. DROP TABLES
-- Orden inverso de dependencias: primero la tabla de hechos (ventas),
-- luego productos, clientes y por último categorias.
-- ============================================================
...
-- ============================================================
-- 2. CREATE TABLES
-- Orden: primero las dimensiones (categorias, clientes), luego
-- productos (depende de categorias) y al final ventas (tabla de
-- hechos, depende de clientes y productos).
-- ============================================================
...
CREATE TABLE productos (
    ...
    stock               INT DEFAULT 0,
    -- Nota: la consigna original pedía TINYINT(1) para "activo", pero ese
    -- tipo no es válido en PostgreSQL y no admite precisión en SQL Server.
    -- Se usa SMALLINT (0/1) para que el script corra sin errores en ambos motores.
